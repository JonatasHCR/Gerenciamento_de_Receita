...
ActiveRecord::Schema[8.1].define(version: 2026_07_13_120000) do
  ...
  create_table "letter_sequences", force: :cascade do |t|
    t.bigint "cost_center_id", null: false
    t.datetime "created_at", null: false
    t.integer "last_sequence", default: 0, null: false
    t.datetime "updated_at", null: false
    t.integer "year", null: false
    t.index ["cost_center_id", "year"], name: "index_letter_sequences_on_cost_center_id_and_year", unique: true
  end
  ...
  add_foreign_key "letter_sequences", "cost_centers"
